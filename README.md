...
本リポジトリは、Archive Deskを個人で開発・検証するための非商用プロジェクトとして公開しています。

このコードをもとに、利用者それぞれの環境や目的に合わせて、自由に改変・改善してください。より便利な別バージョン、派生版、独自の執筆機能を備えたエディタを作ることも歓迎します。

改変版を公開する場合は、元プロジェクトとしてArchive Deskを利用したことや、元版との違いをREADMEなどに記載していただけると、利用者にとって分かりやすくなります。改善内容や新しいアイデアの共有も歓迎します。

このプロジェクトは、個人開発者同士が長編小説向けの執筆環境を発展させていくための土台として公開しています。商用利用を含む具体的な利用条件については、今後のLICENSEファイル追加時に正式に明記します。
